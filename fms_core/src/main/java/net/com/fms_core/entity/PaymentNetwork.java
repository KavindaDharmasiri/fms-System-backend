...
public class PaymentNetwork implements Serializable {
    ...
    public PaymentNetwork(String networkName, Double bin, Double binLength, String status, String createdBy, String updatedBy) {
    ...
    public Collection<FmsRule> getFmsRuleCollection() {
        return FmsRuleCollection;
    }
