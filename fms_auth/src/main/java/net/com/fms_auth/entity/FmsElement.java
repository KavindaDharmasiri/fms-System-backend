...
public class FmsElement implements Serializable {
    ...
    public FmsElement(Integer fmsElementId, String elementCode, String elementName, String description, String validation, double riskWeight, String operator, String value, String status, Date created, Date updated, String createdBy, String updatedBy) {
        this.fmsElementId = fmsElementId;
